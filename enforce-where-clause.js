module.exports = {
  meta: {
    type: "problem",
    docs: {
      description: "Ensures that any call chain which affects a table also includes a 'where' clause.",
    },
    fixable: "code",
    schema: [], // no options
  },
  create(context) {
    ...
    function evaluate(expression) {
      ...
      const hasUpdateOrDelete = hasMethodsInChain(expression, ["updateTable", "deleteFrom"]);
